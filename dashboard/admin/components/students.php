  ...
  <form action="" method="post" class="formx">
    <button class="std-bttn" type="sumbit" name="add-std">
      <div class="student-item">
        <img src="../images/user.png" style="height: 150px" alt="cutm" />
    ...
    <button class="std-bttn" type="sumbit" name="view-std">
      <div class="student-item">
        <img src="../images/user22.png" style="height: 150px" alt="cutm" />
        <!-- <h3 class="ah">ADD STUDENTS</h3> -->
      </div>
    </button>
</form>
...
<?php
    ...
    if(isset($_POST['add-std'])){
        ...
        header("Location: http://localhost/cbcs_tracker/dashboard/admin/components/admin.php?page=add_students");
    }
